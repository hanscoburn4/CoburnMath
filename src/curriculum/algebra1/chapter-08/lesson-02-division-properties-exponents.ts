...
export const lessonData: CurriculumLesson = {
  ...
  description: 'Under construction - Learn division properties of exponents.',
  learningObjectives: [
    'Under construction'
  ],
  keyConceptsFile: 'algebra1/chapter-08/concepts/division-properties-exponents-concepts.md',
  thinkingTask: {
