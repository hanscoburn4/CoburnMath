...
export const lessonData: CurriculumLesson = {
  ...
  description: 'Under construction - Study medians and altitudes in triangles.',
  learningObjectives: [
    'Under construction'
  ],
  keyConceptsFile: 'geometry/chapter-06/concepts/medians-altitudes-triangles-concepts.md',
  thinkingTask: {
