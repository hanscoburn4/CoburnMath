...
export const lessonData: CurriculumLesson = {
  ...
  description: 'Under construction - Study parallel lines and transversals.',
  learningObjectives: [
    'Under construction'
  ],
  keyConceptsFile: 'geometry/chapter-03/concepts/parallel-lines-transversals-concepts.md',
  thinkingTask: {
