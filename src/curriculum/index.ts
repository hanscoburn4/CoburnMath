...
import * as algebra2_ch2_lesson4 from './algebra2/chapter-02/lesson-04-solving-systems-equations-graphically';
import * as algebra2_ch2_lesson5 from './algebra2/chapter-02/lesson-05-solving-systems-equations-algebraically';
import * as algebra2_ch2_lesson6 from './algebra2/chapter-02/lesson-06-solving-systems-inequalities';
import * as algebra2_ch2_lesson8 from './algebra2/chapter-02/lesson-08-systems-equations-three-variables';

import * as algebra2_ch3_lesson1 from './algebra2/chapter-03/lesson-01-graphing-quadratic-functions';
import * as algebra2_ch3_lesson2 from './algebra2/chapter-03/lesson-02-solving-quadratic-equations-graphing';
import * as algebra2_ch3_lesson3 from './algebra2/chapter-03/lesson-03-complex-numbers';
import * as algebra2_ch3_lesson4 from './algebra2/chapter-03/lesson-04-solving-quadratic-equations-factoring';
import * as algebra2_ch3_lesson5 from './algebra2/chapter-03/lesson-05-solving-quadratic-equations-completing-square';
import * as algebra2_ch3_lesson6 from './algebra2/chapter-03/lesson-06-quadratic-formula-discriminant';

import * as algebra2_ch4_lesson1 from './algebra2/chapter-04/lesson-01-polynomial-functions';
import * as algebra2_ch4_lesson3 from './algebra2/chapter-04/lesson-03-operations-polynomials';
import * as algebra2_ch4_lesson4 from './algebra2/chapter-04/lesson-04-dividing-polynomials';

import * as algebra2_ch5_lesson1 from './algebra2/chapter-05/lesson-01-solving-polynomial-equations-graphing';
import * as algebra2_ch5_lesson2 from './algebra2/chapter-05/lesson-02-solving-polynomial-equations-algebraically';
import * as algebra2_ch5_lesson4 from './algebra2/chapter-05/lesson-04-remainder-factor-theorems';
import * as algebra2_ch5_lesson5 from './algebra2/chapter-05/lesson-05-roots-zeros';

import * as algebra2_ch6_lesson1 from './algebra2/chapter-06/lesson-01-operations-functions';
import * as algebra2_ch6_lesson2 from './algebra2/chapter-06/lesson-02-inverse-relations-functions';
import * as algebra2_ch6_lesson3 from './algebra2/chapter-06/lesson-03-nth-roots-rational-exponents';
import * as algebra2_ch6_lesson4 from './algebra2/chapter-06/lesson-04-graphing-radical-functions';
import * as algebra2_ch6_lesson5 from './algebra2/chapter-06/lesson-05-operations-radical-functions';
import * as algebra2_ch6_lesson6 from './algebra2/chapter-06/lesson-06-solving-radical-equations';

import * as algebra2_ch7_lesson1 from './algebra2/chapter-07/lesson-01-graphing-exponential-functions';
import * as algebra2_ch7_lesson2 from './algebra2/chapter-07/lesson-02-solving-exponential-equations-inequalities';
import * as algebra2_ch7_lesson3 from './algebra2/chapter-07/lesson-03-special-exponential-functions';
import * as algebra2_ch7_lesson5 from './algebra2/chapter-07/lesson-05-modeling-data';

import * as algebra2_ch8_lesson1 from './algebra2/chapter-08/lesson-01-logarithms-logarithmic-functions';
import * as algebra2_ch8_lesson2 from './algebra2/chapter-08/lesson-02-properties-logarithms';
import * as algebra2_ch8_lesson3 from './algebra2/chapter-08/lesson-03-common-logarithms';
import * as algebra2_ch8_lesson4 from './algebra2/chapter-08/lesson-04-natural-logarithms';
import * as algebra2_ch8_lesson5 from './algebra2/chapter-08/lesson-05-using-exponential-logarithmic-functions';

import * as algebra2_ch9_lesson1 from './algebra2/chapter-09/lesson-01-multiplying-dividing-rational-expressions';
import * as algebra2_ch9_lesson2 from './algebra2/chapter-09/lesson-02-adding-subtracting-rational-expressions';
import * as algebra2_ch9_lesson3 from './algebra2/chapter-09/lesson-03-graphing-reciprocal-functions';
import * as algebra2_ch9_lesson4 from './algebra2/chapter-09/lesson-04-graphing-rational-functions';
import * as algebra2_ch9_lesson5 from './algebra2/chapter-09/lesson-05-variation';
import * as algebra2_ch9_lesson6 from './algebra2/chapter-09/lesson-06-solving-rational-equations-inequalities';
    ...
    chapters: [
      ...
      },
      {
        ...
        lessons: [
          ...
          algebra2_ch2_lesson4.lessonData,
          algebra2_ch2_lesson5.lessonData,
          algebra2_ch2_lesson6.lessonData,
          algebra2_ch2_lesson8.lessonData
        ]
      },
      {
        id: 'quadratic-functions',
        ...
        lessons: [
          ...
          algebra2_ch3_lesson2.lessonData,
          algebra2_ch3_lesson3.lessonData,
          algebra2_ch3_lesson4.lessonData,
          algebra2_ch3_lesson5.lessonData,
          algebra2_ch3_lesson6.lessonData
        ]
      },
      {
        id: 'polynomials-polynomial-functions',
        title: 'Module 4: Polynomials and Polynomial Functions',
        description: 'Work with polynomial expressions and functions.',
        lessons: [
          algebra2_ch4_lesson1.lessonData,
          algebra2_ch4_lesson3.lessonData,
          algebra2_ch4_lesson4.lessonData
        ]
      },
      {
        ...
        lessons: [
          algebra2_ch5_lesson1.lessonData,
          algebra2_ch5_lesson2.lessonData,
          algebra2_ch5_lesson4.lessonData,
          algebra2_ch5_lesson5.lessonData
        ]
      },
      {
        id: 'inverse-radical-functions',
        title: 'Module 6: Inverse and Radical Functions',
        description: 'Study inverse functions and radical expressions.',
        lessons: [
          algebra2_ch6_lesson1.lessonData,
          algebra2_ch6_lesson2.lessonData,
          algebra2_ch6_lesson3.lessonData,
          algebra2_ch6_lesson4.lessonData,
          algebra2_ch6_lesson5.lessonData,
          algebra2_ch6_lesson6.lessonData
        ]
      },
      {
        id: 'exponential-functions',
        ...
        lessons: [
          ...
          algebra2_ch7_lesson2.lessonData,
          algebra2_ch7_lesson3.lessonData,
          algebra2_ch7_lesson5.lessonData
        ]
      },
      {
        ...
        lessons: [
          ...
          algebra2_ch8_lesson2.lessonData,
          algebra2_ch8_lesson3.lessonData,
          algebra2_ch8_lesson4.lessonData,
          algebra2_ch8_lesson5.lessonData
        ]
      },
      {
        ...
        lessons: [
          ...
          algebra2_ch9_lesson2.lessonData,
          algebra2_ch9_lesson3.lessonData,
          algebra2_ch9_lesson4.lessonData,
          algebra2_ch9_lesson5.lessonData,
          algebra2_ch9_lesson6.lessonData
        ]
      }
    ]
  },
